...
bool turtlebot_msgs__msg__version_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlebot_msgs.msg._version_info.VersionInfo", full_classname_dest, 44) == 0);
  }
  turtlebot_msgs__msg__VersionInfo * ros_message = _ros_message;
  {  // hardware
...
PyObject * turtlebot_msgs__msg__version_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlebot_msgs.msg._version_info");
