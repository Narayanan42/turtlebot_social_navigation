...
#ifndef TURTLEBOT_MSGS__MSG__DETAIL__SOUND__STRUCT_HPP_
#define TURTLEBOT_MSGS__MSG__DETAIL__SOUND__STRUCT_HPP_
...
#ifndef _WIN32
# define DEPRECATED__turtlebot_msgs__msg__Sound __attribute__((deprecated))
#else
# define DEPRECATED__turtlebot_msgs__msg__Sound __declspec(deprecated)
#endif
...
#  pragma pop_macro("ERROR")
  ...
  // pointer types
  using RawPtr =
    turtlebot_msgs::msg::Sound_<ContainerAllocator> *;
  using ConstRawPtr =
    const turtlebot_msgs::msg::Sound_<ContainerAllocator> *;
  using SharedPtr =
    std::shared_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator>>;
  using ConstSharedPtr =
    std::shared_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator> const>;

  template<typename Deleter = std::default_delete<
      turtlebot_msgs::msg::Sound_<ContainerAllocator>>>
  using UniquePtrWithDeleter =
    std::unique_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator>, Deleter>;
  ...
  using ConstUniquePtrWithDeleter =
    std::unique_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator> const, Deleter>;
  using ConstUniquePtr = ConstUniquePtrWithDeleter<>;

  using WeakPtr =
    std::weak_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator>>;
  using ConstWeakPtr =
    std::weak_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator> const>;

  // pointer types similar to ROS 1, use SharedPtr / ConstSharedPtr instead
  // NOTE: Can't use 'using' here because GNU C++ can't parse attributes properly
  typedef DEPRECATED__turtlebot_msgs__msg__Sound
    std::shared_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator>>
    Ptr;
  typedef DEPRECATED__turtlebot_msgs__msg__Sound
    std::shared_ptr<turtlebot_msgs::msg::Sound_<ContainerAllocator> const>
...
using Sound =
  turtlebot_msgs::msg::Sound_<std::allocator<void>>;
...
#endif  // TURTLEBOT_MSGS__MSG__DETAIL__SOUND__STRUCT_HPP_
