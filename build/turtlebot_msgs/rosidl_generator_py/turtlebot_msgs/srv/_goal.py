...
class Metaclass_Goal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from turtlebot_msgs.srv import _goal
...
class Goal(metaclass=Metaclass_Goal):
    from turtlebot_msgs.srv._goal import Goal_Request as Request
    from turtlebot_msgs.srv._goal import Goal_Response as Response
