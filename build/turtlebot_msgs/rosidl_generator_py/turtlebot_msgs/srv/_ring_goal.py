...
class Metaclass_RingGoal(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from turtlebot_msgs.srv import _ring_goal
...
class RingGoal(metaclass=Metaclass_RingGoal):
    from turtlebot_msgs.srv._ring_goal import RingGoal_Request as Request
    from turtlebot_msgs.srv._ring_goal import RingGoal_Response as Response
