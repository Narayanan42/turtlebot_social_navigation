...
static const _VersionInfo_type_support_symbol_names_t _VersionInfo_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_msgs, msg, VersionInfo)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, turtlebot_msgs, msg, VersionInfo)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, turtlebot_msgs, msg, VersionInfo)() {
  return &::turtlebot_msgs::msg::rosidl_typesupport_c::VersionInfo_message_type_support_handle;
}
