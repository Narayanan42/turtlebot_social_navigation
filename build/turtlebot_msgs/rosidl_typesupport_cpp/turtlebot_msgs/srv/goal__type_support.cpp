...
static const _Goal_Request_type_support_symbol_names_t _Goal_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, srv, Goal_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_msgs, srv, Goal_Request)),
  }
};
...
{
  return &::turtlebot_msgs::srv::rosidl_typesupport_cpp::Goal_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot_msgs, srv, Goal_Request)() {
  return get_message_type_support_handle<turtlebot_msgs::srv::Goal_Request>();
}
...
static const _Goal_Response_type_support_symbol_names_t _Goal_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, srv, Goal_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_msgs, srv, Goal_Response)),
  }
};
...
{
  return &::turtlebot_msgs::srv::rosidl_typesupport_cpp::Goal_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, turtlebot_msgs, srv, Goal_Response)() {
  return get_message_type_support_handle<turtlebot_msgs::srv::Goal_Response>();
}
...
static const _Goal_type_support_symbol_names_t _Goal_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, srv, Goal)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_msgs, srv, Goal)),
  }
};
...
{
  return &::turtlebot_msgs::srv::rosidl_typesupport_cpp::Goal_service_type_support_handle;
}
