...
#include "turtlebot_msgs/msg/detail/sound__rosidl_typesupport_fastrtps_c.h"
...
using _Sound__ros_msg_type = turtlebot_msgs__msg__Sound;
...
size_t get_serialized_size_turtlebot_msgs__msg__Sound(
  const void * untyped_ros_message,
...
static uint32_t _Sound__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlebot_msgs__msg__Sound(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlebot_msgs
size_t max_serialized_size_turtlebot_msgs__msg__Sound(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot_msgs__msg__Sound;
    is_plain =
      (
...
static size_t _Sound__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlebot_msgs__msg__Sound(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_msgs, msg, Sound)() {
