...
#include "turtlebot_msgs/msg/detail/version_info__rosidl_typesupport_fastrtps_c.h"
...
using _VersionInfo__ros_msg_type = turtlebot_msgs__msg__VersionInfo;
...
size_t get_serialized_size_turtlebot_msgs__msg__VersionInfo(
  const void * untyped_ros_message,
...
static uint32_t _VersionInfo__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlebot_msgs__msg__VersionInfo(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlebot_msgs
size_t max_serialized_size_turtlebot_msgs__msg__VersionInfo(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot_msgs__msg__VersionInfo;
    is_plain =
      (
...
static size_t _VersionInfo__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlebot_msgs__msg__VersionInfo(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_msgs, msg, VersionInfo)() {
