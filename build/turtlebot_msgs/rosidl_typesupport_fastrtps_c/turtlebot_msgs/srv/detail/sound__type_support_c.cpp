...
#include "turtlebot_msgs/srv/detail/sound__rosidl_typesupport_fastrtps_c.h"
...
using _Sound_Request__ros_msg_type = turtlebot_msgs__srv__Sound_Request;
...
size_t get_serialized_size_turtlebot_msgs__srv__Sound_Request(
  const void * untyped_ros_message,
...
static uint32_t _Sound_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlebot_msgs__srv__Sound_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlebot_msgs
size_t max_serialized_size_turtlebot_msgs__srv__Sound_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot_msgs__srv__Sound_Request;
    is_plain =
      (
...
static size_t _Sound_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlebot_msgs__srv__Sound_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_msgs, srv, Sound_Request)() {
...
using _Sound_Response__ros_msg_type = turtlebot_msgs__srv__Sound_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlebot_msgs
size_t get_serialized_size_turtlebot_msgs__srv__Sound_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Sound_Response__ros_msg_type * ros_message = static_cast<const _Sound_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_turtlebot_msgs__srv__Sound_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_turtlebot_msgs
size_t max_serialized_size_turtlebot_msgs__srv__Sound_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlebot_msgs__srv__Sound_Response;
    is_plain =
      (
...
static size_t _Sound_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_turtlebot_msgs__srv__Sound_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_msgs, srv, Sound_Response)() {
...
// already included above
// #include "turtlebot_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "turtlebot_msgs/srv/sound.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, turtlebot_msgs, srv, Sound)() {
