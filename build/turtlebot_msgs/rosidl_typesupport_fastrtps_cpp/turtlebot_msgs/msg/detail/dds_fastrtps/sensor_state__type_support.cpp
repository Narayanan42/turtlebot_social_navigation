...
#include "turtlebot_msgs/msg/detail/sensor_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtlebot_msgs::msg::SensorState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlebot_msgs::msg::SensorState & ros_message)
{
  // Member: header
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot_msgs::msg::SensorState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot_msgs::msg::SensorState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlebot_msgs::msg::SensorState *>(
    untyped_ros_message);
...
{
  return &turtlebot_msgs::msg::typesupport_fastrtps_cpp::_SensorState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, msg, SensorState)() {
  return &turtlebot_msgs::msg::typesupport_fastrtps_cpp::_SensorState__handle;
}
