...
#include "turtlebot_msgs/msg/detail/sound__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtlebot_msgs::msg::Sound & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlebot_msgs::msg::Sound & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot_msgs::msg::Sound;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot_msgs::msg::Sound *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlebot_msgs::msg::Sound *>(
    untyped_ros_message);
...
{
  return &turtlebot_msgs::msg::typesupport_fastrtps_cpp::_Sound__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, msg, Sound)() {
  return &turtlebot_msgs::msg::typesupport_fastrtps_cpp::_Sound__handle;
}
