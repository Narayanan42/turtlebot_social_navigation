...
#include "turtlebot_msgs/msg/detail/version_info__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot_msgs::msg::VersionInfo;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot_msgs::msg::VersionInfo *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlebot_msgs::msg::VersionInfo *>(
    untyped_ros_message);
...
{
  return &turtlebot_msgs::msg::typesupport_fastrtps_cpp::_VersionInfo__handle;
}
