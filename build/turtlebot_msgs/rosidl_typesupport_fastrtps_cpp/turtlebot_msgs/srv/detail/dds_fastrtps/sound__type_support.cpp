...
#include "turtlebot_msgs/srv/detail/sound__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const turtlebot_msgs::srv::Sound_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlebot_msgs::srv::Sound_Request & ros_message)
{
  // Member: value
  cdr >> ros_message.value;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = turtlebot_msgs::srv::Sound_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot_msgs::srv::Sound_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<turtlebot_msgs::srv::Sound_Request *>(
    untyped_ros_message);
...
{
  return &turtlebot_msgs::srv::typesupport_fastrtps_cpp::_Sound_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, srv, Sound_Request)() {
  return &turtlebot_msgs::srv::typesupport_fastrtps_cpp::_Sound_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_turtlebot_msgs
cdr_serialize(
  const turtlebot_msgs::srv::Sound_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: success
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  turtlebot_msgs::srv::Sound_Response & ros_message)
{
  // Member: success
  {
    uint8_t tmp;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = turtlebot_msgs::srv::Sound_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const turtlebot_msgs::srv::Sound_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<turtlebot_msgs::srv::Sound_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &turtlebot_msgs::srv::typesupport_fastrtps_cpp::_Sound_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, srv, Sound_Response)() {
  return &turtlebot_msgs::srv::typesupport_fastrtps_cpp::_Sound_Response__handle;
}
...
{
  return &turtlebot_msgs::srv::typesupport_fastrtps_cpp::_Sound__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, turtlebot_msgs, srv, Sound)() {
  return &turtlebot_msgs::srv::typesupport_fastrtps_cpp::_Sound__handle;
}
