...
{
  new (message_memory) turtlebot_msgs::srv::Sound_Request(_init);
}

void Sound_Request_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlebot_msgs::srv::Sound_Request *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sound_Request_message_member_array[1] = {
  {
    ...
    offsetof(turtlebot_msgs::srv::Sound_Request, value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sound_Request_message_members = {
  ...
  1,  // number of fields
  sizeof(turtlebot_msgs::srv::Sound_Request),
...
{
  return &::turtlebot_msgs::srv::rosidl_typesupport_introspection_cpp::Sound_Request_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_msgs, srv, Sound_Request)() {
  return &::turtlebot_msgs::srv::rosidl_typesupport_introspection_cpp::Sound_Request_message_type_support_handle;
}
...
void Sound_Response_init_function(
  void * message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
  new (message_memory) turtlebot_msgs::srv::Sound_Response(_init);
}

void Sound_Response_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlebot_msgs::srv::Sound_Response *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sound_Response_message_member_array[2] = {
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlebot_msgs::srv::Sound_Response, success),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(turtlebot_msgs::srv::Sound_Response, message),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sound_Response_message_members = {
  ...
  2,  // number of fields
  sizeof(turtlebot_msgs::srv::Sound_Response),
...
{
  return &::turtlebot_msgs::srv::rosidl_typesupport_introspection_cpp::Sound_Response_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_msgs, srv, Sound_Response)() {
  return &::turtlebot_msgs::srv::rosidl_typesupport_introspection_cpp::Sound_Response_message_type_support_handle;
}
...
static ::rosidl_typesupport_introspection_cpp::ServiceMembers Sound_service_members = {
  ...
  // see get_service_type_support_handle<turtlebot_msgs::srv::Sound>()
...
get_service_type_support_handle<turtlebot_msgs::srv::Sound>()
{
  ...
  auto service_type_support =
    &::turtlebot_msgs::srv::rosidl_typesupport_introspection_cpp::Sound_service_type_support_handle;
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_msgs, srv, Sound)() {
  return ::rosidl_typesupport_introspection_cpp::get_service_type_support_handle<turtlebot_msgs::srv::Sound>();
}
