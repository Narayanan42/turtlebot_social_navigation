#ifndef TURTLEBOT_FAKE_NODE__TURTLEBOT_FAKE_NODE_HPP_
#define TURTLEBOT_FAKE_NODE__TURTLEBOT_FAKE_NODE_HPP_
...
#include "turtlebot_msgs/msg/sensor_state.hpp"

#define LEFT 0
#define RIGHT 1

class TurtlebotFake : public rclcpp::Node
{
public:
  TurtlebotFake();
  ~TurtlebotFake();
