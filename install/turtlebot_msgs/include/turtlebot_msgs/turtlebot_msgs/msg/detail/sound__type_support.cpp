...
{
  new (message_memory) turtlebot_msgs::msg::Sound(_init);
}

void Sound_fini_function(void * message_memory)
{
  auto typed_message = static_cast<turtlebot_msgs::msg::Sound *>(message_memory);
  typed_message->~Sound();
}
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember Sound_message_member_array[1] = {
  {
    ...
    offsetof(turtlebot_msgs::msg::Sound, value),  // bytes offset in struct
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers Sound_message_members = {
  ...
  "Sound",  // message name
  1,  // number of fields
  sizeof(turtlebot_msgs::msg::Sound),
...
{
  return &::turtlebot_msgs::msg::rosidl_typesupport_introspection_cpp::Sound_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, turtlebot_msgs, msg, Sound)() {
  return &::turtlebot_msgs::msg::rosidl_typesupport_introspection_cpp::Sound_message_type_support_handle;
}
