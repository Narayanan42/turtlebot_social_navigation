...
bool turtlebot_msgs__msg__sensor_state__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("turtlebot_msgs.msg._sensor_state.SensorState", full_classname_dest, 44) == 0);
  }
  turtlebot_msgs__msg__SensorState * ros_message = _ros_message;
  {  // header
...
PyObject * turtlebot_msgs__msg__sensor_state__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("turtlebot_msgs.msg._sensor_state");
