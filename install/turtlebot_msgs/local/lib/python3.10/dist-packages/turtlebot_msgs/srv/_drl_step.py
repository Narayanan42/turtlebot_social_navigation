...
class Metaclass_DrlStep(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from turtlebot_msgs.srv import _drl_step
...
class DrlStep(metaclass=Metaclass_DrlStep):
    from turtlebot_msgs.srv._drl_step import DrlStep_Request as Request
    from turtlebot_msgs.srv._drl_step import DrlStep_Response as Response
