...
class DRLGazebo(Node):
    def __init__(self):
        ...
        ************************************************************"""
        ...
        self.entity_path = os.path.join('/home/nanu/turtlebot3_drlnav', 'src/turtlebot3_simulations/turtlebot3_gazebo/models/turtlebot3_drl_world/goal_box/model.sdf')
    ...
    *******************************************************************************"""
    ...
    def get_obstacle_coordinates(self):
        tree = ET.parse(os.getenv('DRLNAV_BASE_PATH') + '/src/turtlebot3_simulations/turtlebot3_gazebo/models/corr/model.sdf')
        root = tree.getroot()
