...
REAL_N_SCAN_SAMPLES         = 1080

REAL_ARENA_LENGTH           = 4.0   # meters
REAL_ARENA_WIDTH            = 2.5   # meters
REAL_SPEED_LINEAR_MAX       = 0.30  # in m/s
...
REAL_THRESHOLD_COLLISION    = 0.3  # meters, minimum distance to an object that counts as a collision
